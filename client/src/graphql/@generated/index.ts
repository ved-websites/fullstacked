...
export type GetEditableUserQuery = { getUser?: { email: string, firstName?: string | null, lastName?: string | null, roles: Array<{ value: string }> } | null };
...
export type CreateNewUserMutation = { createUser: { email: string, firstName: string, lastName: string } };
