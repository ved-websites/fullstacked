<script lang="ts">
	...
	export let color: svelte.JSX.SVGAttributes<SVGSVGElement>['color'] = '#000';
</script>

<!-- By Sam Herbert (@sherb), for everyone. More @ http://goo.gl/7AJzbL -->
<svg class={classes} {height} viewBox="0 0 38 38" preserveAspectRatio="xMidYMin slice" xmlns="http://www.w3.org/2000/svg">
	<defs>
